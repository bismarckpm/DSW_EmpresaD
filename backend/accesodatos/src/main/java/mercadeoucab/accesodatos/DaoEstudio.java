...
public class DaoEstudio extends Dao<Estudio>{
    ...
    public List<Estudio> estudiosAplicanUsuario(DatoEncuestado datoEncuestado){
        ...
        try {
            ...
            estudios.setParameter("edad", datoEncuestado.getEdad());
            resultado = estudios.getResultList();
            _em.flush();
            _em.clear();
            _handler.finishTransaction();
    ...
    public List<Usuario> personasAplicanEstudio(Estudio estudio){
        ...
        try {
            ...
            usuarios.setParameter("edadInicial", estudio.getSolicitud().getFk_muestra_poblacion().getRangoEdadInicio());
            usuarios.setParameter("edadFinal", estudio.getSolicitud().getFk_muestra_poblacion().getRangoEdadFin());
