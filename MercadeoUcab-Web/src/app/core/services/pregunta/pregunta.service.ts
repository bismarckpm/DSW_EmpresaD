...
export class PreguntaService {
  ...
  createPregunta(data) 
  {
    ...
    return this._http.post(this.url + '/preguntas/', JSON.stringify(data), {headers: headers});
  }

  updatePregunta(id, data) {
    const headers = new HttpHeaders().set('Content-Type', 'application/json');
    return this._http.put(this.url + '/preguntas/' + id, JSON.stringify(data), {headers: headers});
  }
